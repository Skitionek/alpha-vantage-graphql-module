...
test(`intraday data polishing works`, () => {
  ...
  expect(polished['data.unit.test.js']).toBeDefined();
  first = Object.keys(polished['data.unit.test.js'])[0];
  expect(first).toBeDefined();
  expect(polished['data.unit.test.js'][first]['1. open']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['2. high']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['3. low']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['4. close']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['5. volume']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['open']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['high']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['low']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['close']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['volume']).toBeDefined();
});
...
test(`adjusted data polishing works`, () => {
  ...
  expect(polished['data.unit.test.js'][first]['3. low']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['4. close']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['5. adjusted close']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['6. volume']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['7. dividend amount']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['8. split coefficient']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['open']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['high']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['low']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['close']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['adjusted']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['volume']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['dividend']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['split']).toBeDefined();
});
...
test(`daily crypto polishing works`, () => {
  ...
  first = Object.keys(polished['data.unit.test.js'])[0];
  expect(first).toBeDefined();
  expect(polished['data.unit.test.js'][first]['1a. open (CNY)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['1b. open (USD)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['2a. high (CNY)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['2b. high (USD)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['3a. low (CNY)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['3b. low (USD)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['4a. close (CNY)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['4b. close (USD)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['5. volume']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['6. market cap (USD)']).toBeUndefined();
  expect(polished['data.unit.test.js'][first]['market_open']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['market_high']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['market_low']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['market_close']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['usd_open']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['usd_high']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['usd_low']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['usd_close']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['volume']).toBeDefined();
  expect(polished['data.unit.test.js'][first]['cap']).toBeDefined();
});
