...
import {
	...
	CryptocurrencyParamsSet,
	ForeignExchangeParamsSet,
	ForeignExchangeSymbols,
	StockParamsSet,
	SymbolSearchParamsSet
} from "./mocks";
...
describe('alphaVantage.module', () => {
	...
	describe('Stock', () => {
		describe.each(StockParamsSet)("%j", variables => {
			let response;
			beforeAll(() =>
	...
	describe('cryptocurrencyExchangeRate', () => {
		describe.each(CryptocurrencyExchangeRateParamsSet)("%j", CryptocurrencyExchangeRateParams => {
			const variables = {
				...ForeignExchangeSymbols,
	...
	describe('foreignExchange', () => {
		describe.each(ForeignExchangeParamsSet)("%j", variables => {
			let response;
			beforeAll(() =>
	...
	describe('cryptocurrency', () => {
		describe.each(CryptocurrencyParamsSet)("%j", CryptocurrencyParams => {
			describe.each(CryptocurrencyExchangeRateParamsSet)("%j", CryptocurrencyExchangeRateParams => {
				const variables = {
					...CryptocurrencyExchangeRateParams,
	...
	describe('symbolSearch', () => {
		describe.each(SymbolSearchParamsSet)("%j", variables => {
			let response;
			beforeAll(() =>
